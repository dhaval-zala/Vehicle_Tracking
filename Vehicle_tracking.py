...
flags.DEFINE_string('output', './data/video/20210325113656(output_).avi', 'path to output video')
...
def main(_argv):
    ...
    while True:
        ...
        #         temp_current_count += 1
        #         #temp_counter.append(temp_current_count)
        # total_count = len(set(counter))
        # final_count = temp_current_count + (total_count - current_count)
        #cv2.putText(img, "Current Vehicle Count: " + str(current_count), (0, 80), 0, 1, (0, 0, 255), 2)
        cv2.putText(img, "Total Vehicles Cross the line: " + str(total_count), (0, 80), 0, 1, (0, 0, 255), 2)
